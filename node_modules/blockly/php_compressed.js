...
var Pr=function(a,b){var c=0,d="";b.STATEMENT_PREFIX&&(d+=b.injectId(b.STATEMENT_PREFIX,a));do{var e=b.valueToCode(a,"IF"+c,V.NONE)||"false";var f=b.statementToCode(a,"DO"+c);b.STATEMENT_SUFFIX&&(f=b.prefixLines(b.injectId(b.STATEMENT_SUFFIX,a),b.INDENT)+f);d+=(c>0?" else ":"")+"if ("+e+") {\n"+f+"}";c++}while(a.getInput("IF"+c));if(a.getInput("ELSE")||b.STATEMENT_SUFFIX)f=a.getInput("ELSE")?b.statementToCode(a,"ELSE"):"",b.STATEMENT_SUFFIX&&(f=b.prefixLines(b.injectId(b.STATEMENT_SUFFIX,a),b.INDENT)+
f),d+=" else {\n"+f+"}";return d+"\n"},Qr=function(a,b){var c=a.getField("TIMES")?String(Number(a.getFieldValue("TIMES"))):b.valueToCode(a,"TIMES",V.ASSIGNMENT)||"0";var d=b.statementToCode(a,"DO");d=b.addLoopTrap(d,a);a="";var e=b.nameDB_.getDistinctName("count",$.P.VARIABLE),f=c;c.match(/^\w+$/)||$.df(c)||(f=b.nameDB_.getDistinctName("repeat_end",$.P.VARIABLE),a+=f+" = "+c+";\n");return a+("for ("+e+" = 0; "+e+" < "+f+"; "+e+"++) {\n"+d+"}\n")},Rr=function(a,b){var c=a.getFieldValue("OP");if(c===
...
break;case "SIN":d="sin("+a+" / 180 * pi())";break;case "COS":d="cos("+a+" / 180 * pi())";break;case "TAN":d="tan("+a+" / 180 * pi())"}if(d)return[d,V.FUNCTION_CALL];switch(c){case "LOG10":d="log("+a+") / log(10)";break;case "ASIN":d="asin("+a+") / pi() * 180";break;case "ACOS":d="acos("+a+") / pi() * 180";break;case "ATAN":d="atan("+a+") / pi() * 180";break;default:throw Error("Unknown math operator: "+c);}return[d,V.DIVISION]},Sr=function(a,b){var c=[],d=a.workspace,e=$.Ad(d)||[];for(var f of e)e=
...
var g="";a.getInput("STACK")&&(g=b.statementToCode(a,"STACK"));var h="";a.getInput("RETURN")&&(h=b.valueToCode(a,"RETURN",V.NONE)||"");var m="";g&&h&&(m=f);h&&(h=b.INDENT+"return "+h+";\n");var z=[],E=a.getVarModels();for(let G=0;G<E.length;G++)z[G]=b.getVariableName(E[G].getId());d="function "+c+"("+z.join(", ")+") {\n"+d+f+e+g+m+h+"}";d=b.scrub_(a,d);b.definitions_["%"+c]=d;return null},Tr=function(a,b){b="readline("+(a.getField("TEXT")?b.quote_(a.getFieldValue("TEXT")):b.valueToCode(a,"TEXT",V.NONE)||
"''")+")";a.getFieldValue("TYPE")==="NUMBER"&&(b="floatval("+b+")");return[b,V.FUNCTION_CALL]},Ur=function(a,b){return[b.getVariableName(a.getFieldValue("VAR")),V.ATOMIC]},Vr=function(a,b){var c=b.valueToCode(a,"VALUE",V.ASSIGNMENT)||"0";return b.getVariableName(a.getFieldValue("VAR"))+" = "+c+";\n"},V,W=V||(V={});W[W.ATOMIC=0]="ATOMIC";W[W.CLONE=1]="CLONE";W[W.NEW=1]="NEW";W[W.MEMBER=2.1]="MEMBER";W[W.FUNCTION_CALL=2.2]="FUNCTION_CALL";W[W.POWER=3]="POWER";W[W.INCREMENT=4]="INCREMENT";
...
var Wr=class extends $.Ip{constructor(a="PHP"){super(a);this.ORDER_OVERRIDES=[[V.MEMBER,V.FUNCTION_CALL],[V.MEMBER,V.MEMBER],[V.LOGICAL_NOT,V.LOGICAL_NOT],[V.MULTIPLICATION,V.MULTIPLICATION],[V.ADDITION,V.ADDITION],[V.LOGICAL_AND,V.LOGICAL_AND],[V.LOGICAL_OR,V.LOGICAL_OR]];this.isInitialized=!1;for(let b in V)a=V[b],typeof a!=="string"&&(this["ORDER_"+b]=a);this.addReservedWords("__halt_compiler,abstract,and,array,as,break,callable,case,catch,class,clone,const,continue,declare,default,die,do,echo,else,elseif,empty,enddeclare,endfor,endforeach,endif,endswitch,endwhile,eval,exit,extends,final,for,foreach,function,global,goto,if,implements,include,include_once,instanceof,insteadof,interface,isset,list,namespace,new,or,print,private,protected,public,require,require_once,return,static,switch,throw,trait,try,unset,use,var,while,xor,PHP_VERSION,PHP_MAJOR_VERSION,PHP_MINOR_VERSION,PHP_RELEASE_VERSION,PHP_VERSION_ID,PHP_EXTRA_VERSION,PHP_ZTS,PHP_DEBUG,PHP_MAXPATHLEN,PHP_OS,PHP_SAPI,PHP_EOL,PHP_INT_MAX,PHP_INT_SIZE,DEFAULT_INCLUDE_PATH,PEAR_INSTALL_DIR,PEAR_EXTENSION_DIR,PHP_EXTENSION_DIR,PHP_PREFIX,PHP_BINDIR,PHP_BINARY,PHP_MANDIR,PHP_LIBDIR,PHP_DATADIR,PHP_SYSCONFDIR,PHP_LOCALSTATEDIR,PHP_CONFIG_FILE_PATH,PHP_CONFIG_FILE_SCAN_DIR,PHP_SHLIB_SUFFIX,E_ERROR,E_WARNING,E_PARSE,E_NOTICE,E_CORE_ERROR,E_CORE_WARNING,E_COMPILE_ERROR,E_COMPILE_WARNING,E_USER_ERROR,E_USER_WARNING,E_USER_NOTICE,E_DEPRECATED,E_USER_DEPRECATED,E_ALL,E_STRICT,__COMPILER_HALT_OFFSET__,TRUE,FALSE,NULL,__CLASS__,__DIR__,__FILE__,__FUNCTION__,__LINE__,__METHOD__,__NAMESPACE__,__TRAIT__")}init(a){super.init(a);
this.nameDB_?this.nameDB_.reset():this.nameDB_=new $.aj(this.RESERVED_WORDS_,"$");this.nameDB_.setVariableMap(a.getVariableMap());this.nameDB_.populateVariables(a);this.nameDB_.populateProcedures(a);this.isInitialized=!0}finish(a){var b=Object.values(this.definitions_);a=super.finish(a);this.isInitialized=!1;this.nameDB_.reset();return b.join("\n\n")+"\n\n\n"+a}scrubNakedValue(a){return a+";\n"}quote_(a){a=a.replace(/\\/g,"\\\\").replace(/\n/g,"\\\n").replace(/'/g,"\\'");return"'"+a+"'"}multiline_quote_(a){return a.split(/\n/g).map(this.quote_).join(' . "\\n" .\n')}scrub_(a,
b,c=!1){var d="";if(!a.outputConnection||!a.outputConnection.targetConnection){var e=a.getCommentText();e&&(e=$.cf(e,this.COMMENT_WRAP-3),d+=this.prefixLines(e,"// ")+"\n");for(let f=0;f<a.inputList.length;f++)a.inputList[f].type===$.he.VALUE&&(e=a.inputList[f].connection.targetBlock())&&(e=this.allNestedComments(e))&&(d+=this.prefixLines(e,"// "))}a=a.nextConnection&&a.nextConnection.targetBlock();c=c?"":this.blockToCode(a);return d+b+c}getAdjusted(a,b,c=0,d=!1,e=V.NONE){a.workspace.options.oneBasedIndex&&
c--;var f=a.workspace.options.oneBasedIndex?"1":"0",g=e;c>0?g=V.ADDITION:c<0?g=V.SUBTRACTION:d&&(g=V.UNARY_NEGATION);a=this.valueToCode(a,b,g)||f;if(c===0&&!d)return a;if($.df(a))return a=String(Number(a)+c),d&&(a=String(-Number(a))),a;c>0?a=`${a} + ${c}`:c<0&&(a=`${a} - ${-c}`);d&&(a=c?`-(${a})`:`-${a}`);Math.floor(e)>=Math.floor(g)&&(a=`(${a})`);return a}};var Xr={};Xr.controls_if=Pr;Xr.controls_ifelse=Pr;Xr.logic_boolean=function(a){return[a.getFieldValue("BOOL")==="TRUE"?"true":"false",V.ATOMIC]};Xr.logic_compare=function(a,b){var c={EQ:"==",NEQ:"!=",LT:"<",LTE:"<=",GT:">",GTE:">="}[a.getFieldValue("OP")],d=c==="=="||c==="!="?V.EQUALITY:V.RELATIONAL,e=b.valueToCode(a,"A",d)||"0";a=b.valueToCode(a,"B",d)||"0";return[e+" "+c+" "+a,d]};Xr.logic_negate=function(a,b){var c=V.LOGICAL_NOT;return["!"+(b.valueToCode(a,"BOOL",c)||"true"),c]};
Xr.logic_null=function(){return["null",V.ATOMIC]};Xr.logic_operation=function(a,b){var c=a.getFieldValue("OP")==="AND"?"&&":"||",d=c==="&&"?V.LOGICAL_AND:V.LOGICAL_OR,e=b.valueToCode(a,"A",d);a=b.valueToCode(a,"B",d);e||a?(b=c==="&&"?"true":"false",e||(e=b),a||(a=b)):a=e="false";return[e+" "+c+" "+a,d]};
Xr.logic_ternary=function(a,b){var c=b.valueToCode(a,"IF",V.CONDITIONAL)||"false",d=b.valueToCode(a,"THEN",V.CONDITIONAL)||"null";a=b.valueToCode(a,"ELSE",V.CONDITIONAL)||"null";return[c+" ? "+d+" : "+a,V.CONDITIONAL]};var Yr={controls_flow_statements:function(a,b){var c="";b.STATEMENT_PREFIX&&(c+=b.injectId(b.STATEMENT_PREFIX,a));b.STATEMENT_SUFFIX&&(c+=b.injectId(b.STATEMENT_SUFFIX,a));if(b.STATEMENT_PREFIX){let d=a.getSurroundLoop();d&&!d.suppressPrefixSuffix&&(c+=b.injectId(b.STATEMENT_PREFIX,d))}switch(a.getFieldValue("FLOW")){case "BREAK":return c+"break;\n";case "CONTINUE":return c+"continue;\n"}throw Error("Unknown flow statement.");},controls_for:function(a,b){var c=b.getVariableName(a.getFieldValue("VAR")),
d=b.valueToCode(a,"FROM",V.ASSIGNMENT)||"0",e=b.valueToCode(a,"TO",V.ASSIGNMENT)||"0",f=b.valueToCode(a,"BY",V.ASSIGNMENT)||"1",g=b.statementToCode(a,"DO");g=b.addLoopTrap(g,a);if($.df(d)&&$.df(e)&&$.df(f))b=Number(d)<=Number(e),a="for ("+c+" = "+d+"; "+c+(b?" <= ":" >= ")+e+"; "+c,c=Math.abs(Number(f)),a=c===1?a+(b?"++":"--"):a+((b?" += ":" -= ")+c),a+=") {\n"+g+"}\n";else{a="";let h=d;d.match(/^\w+$/)||$.df(d)||(h=b.nameDB_.getDistinctName(c+"_start",$.P.VARIABLE),a+=h+" = "+d+";\n");d=e;e.match(/^\w+$/)||
$.df(e)||(d=b.nameDB_.getDistinctName(c+"_end",$.P.VARIABLE),a+=d+" = "+e+";\n");e=b.nameDB_.getDistinctName(c+"_inc",$.P.VARIABLE);a+=e+" = ";a=$.df(f)?a+(Math.abs(Number(f))+";\n"):a+("abs("+f+");\n");a+="if ("+h+" > "+d+") {\n";a+=b.INDENT+e+" = -"+e+";\n";a=a+"}\nfor ("+(c+" = "+h+"; "+e+" >= 0 ? "+c+" <= "+d+" : "+c+" >= "+d+"; "+c+" += "+e+") {\n"+g+"}\n")}return a},controls_forEach:function(a,b){var c=b.getVariableName(a.getFieldValue("VAR")),d=b.valueToCode(a,"LIST",V.ASSIGNMENT)||"[]",e=
b.statementToCode(a,"DO");e=b.addLoopTrap(e,a);return"foreach ("+d+" as "+c+") {\n"+e+"}\n"}};Yr.controls_repeat=Qr;Yr.controls_repeat_ext=Qr;Yr.controls_whileUntil=function(a,b){var c=a.getFieldValue("MODE")==="UNTIL",d=b.valueToCode(a,"BOOL",c?V.LOGICAL_NOT:V.NONE)||"false",e=b.statementToCode(a,"DO");e=b.addLoopTrap(e,a);c&&(d="!"+d);return"while ("+d+") {\n"+e+"}\n"};var Zr={math_arithmetic:function(a,b){var c={ADD:[" + ",V.ADDITION],MINUS:[" - ",V.SUBTRACTION],MULTIPLY:[" * ",V.MULTIPLICATION],DIVIDE:[" / ",V.DIVISION],POWER:[" ** ",V.POWER]}[a.getFieldValue("OP")],d=c[0];c=c[1];var e=b.valueToCode(a,"A",c)||"0";a=b.valueToCode(a,"B",c)||"0";return[e+d+a,c]},math_atan2:function(a,b){var c=b.valueToCode(a,"X",V.NONE)||"0";return["atan2("+(b.valueToCode(a,"Y",V.NONE)||"0")+", "+c+") / pi() * 180",V.DIVISION]},math_change:function(a,b){var c=b.valueToCode(a,"DELTA",
...
`)+"("+c+", "+a+")",V.FUNCTION_CALL]}};Zr.math_round=Rr;Zr.math_single=Rr;Zr.math_trig=Rr;var $r={procedures_callnoreturn:function(a,b){return b.forBlock.procedures_callreturn(a,b)[0]+";\n"},procedures_callreturn:function(a,b){var c=b.getProcedureName(a.getFieldValue("NAME")),d=[],e=a.getVarModels();for(let f=0;f<e.length;f++)d[f]=b.valueToCode(a,"ARG"+f,V.NONE)||"null";return[c+"("+d.join(", ")+")",V.FUNCTION_CALL]}};$r.procedures_defnoreturn=Sr;$r.procedures_defreturn=Sr;
$r.procedures_ifreturn=function(a,b){var c="if ("+(b.valueToCode(a,"CONDITION",V.NONE)||"false")+") {\n";b.STATEMENT_SUFFIX&&(c+=b.prefixLines(b.injectId(b.STATEMENT_SUFFIX,a),b.INDENT));a.hasReturnValue_?(a=b.valueToCode(a,"VALUE",V.NONE)||"null",c+=b.INDENT+"return "+a+";\n"):c+=b.INDENT+"return;\n";return c+"}\n"};var as={text:function(a,b){return[b.quote_(a.getFieldValue("TEXT")),V.ATOMIC]},text_append:function(a,b){var c=b.getVariableName(a.getFieldValue("VAR"));a=b.valueToCode(a,"TEXT",V.ASSIGNMENT)||"''";return c+" .= "+a+";\n"},text_changeCase:function(a,b){b=b.valueToCode(a,"TEXT",V.NONE)||"''";var c;a.getFieldValue("CASE")==="UPPERCASE"?c="strtoupper("+b+")":a.getFieldValue("CASE")==="LOWERCASE"?c="strtolower("+b+")":a.getFieldValue("CASE")==="TITLECASE"&&(c="ucwords(strtolower("+b+"))");return[c,V.FUNCTION_CALL]},
...
}switch(e){case "FROM_START":b=b.getAdjusted(a,"AT2",0,!1,V.SUBTRACTION);b+=" - ";b=$.df(String(d))||String(d).match(/^\(.+\)$/)?b+d:b+("("+d+")");b+=" + 1";break;case "FROM_END":b=b.getAdjusted(a,"AT2",0,!1,V.SUBTRACTION);b="count("+c+") - "+b+" - ";b=$.df(String(d))||String(d).match(/^\(.+\)$/)?b+d:b+("("+d+")");break;case "LAST":b="count("+c+") - ";b=$.df(String(d))||String(d).match(/^\(.+\)$/)?b+d:b+("("+d+")");break;default:throw Error("Unhandled option (lists_getSublist).");}c="array_slice("+
...
`)+"("+c+', "'+a+'", '+d+")",V.FUNCTION_CALL]},lists_split:function(a,b){var c=b.valueToCode(a,"INPUT",V.NONE);b=b.valueToCode(a,"DELIM",V.NONE)||"''";a=a.getFieldValue("MODE");if(a==="SPLIT")c||(c="''"),a="explode";else if(a==="JOIN")c||(c="array()"),a="implode";else throw Error("Unknown mode: "+a);return[a+"("+b+", "+c+")",V.FUNCTION_CALL]}},Xr,Yr,Zr,$r,as,bs,cs);for(let a in es)ds.forBlock[a]=es[a];var fs={};fs.Order=V;fs.PhpGenerator=Wr;fs.phpGenerator=ds;$.__chunk_php=fs;
